...
(function () {
    ...
    client.registerAction("Match22_getdata", function (request, resolve, reject) {
        ...
        call = function(num) {
            ...
            document.cookie = '__yr_token__=' + (new ABC).z(seed, parseInt(new Date().getTime()) + (480 + (new Date).getTimezoneOffset()) * 60 * 1e3) + ';path=/'
            var list = {
